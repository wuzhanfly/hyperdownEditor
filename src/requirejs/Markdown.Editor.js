...
define(['jquery', 'pagedown_sanitizer', 'sfModal', 'pagedown_extra', 'fileUpload'], function ($, Markdown, sfModal) {
    'use strict';
    var util = {},
        position = {},
        ui = {},
                        ...
                        show: function() {
                            ...
                            $('#editorUpload').fileUpload({
                                ...
                                beforeSend: function() {
                                    ...
                                    if($('#editorUpload')[0].files[0].size > 4194304) {
                                        sfModal('图片过大，只能上传小于 4MB 的图片。');
                                        $('#editorUpload')[0].files = null;
                                        return;
                                    }
                                    if(_fileName.indexOf('\\fakepath') !== -1) {
                                        _fileName = _fileName.split('\\fakepath\\')[1];
                                    }
                                    // 拖来的图片必须调用神奇的undefined 的 trick 方法
                                    if(!_fileName) _fileName.trick();
